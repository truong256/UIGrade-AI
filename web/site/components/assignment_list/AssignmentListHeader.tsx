...
export const AssignmentListHeader: FC<AssignmentListHeaderProps> = ({
    ...
    return (
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 className="flex items-center gap-2.5 text-2xl sm:text-3xl font-bold tracking-tight text-[#172033]">
            ...
            {showCreate && (
                onOpenCreateModal ? (
                    <button
                        ...
                        className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 text-xs sm:text-sm font-semibold text-white shadow-xs transition hover:bg-blue-700 active:scale-98 shrink-0"
                    >
