...
export const AssignmentListFilters: FC<AssignmentListFiltersProps> = ({
    ...
    return (
        <div className="flex flex-col gap-3 rounded-2xl border border-sky-100 bg-white p-4 shadow-xs lg:flex-row lg:items-center lg:justify-between">
            <div className="relative flex-1">
                ...
                <input
                    ...
                    className="h-10 w-full rounded-xl border border-slate-200 pl-10 pr-4 text-xs outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-100"
                />
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2.5">
                <select
                    ...
                    className="h-10 rounded-xl border border-slate-200 px-3 text-xs outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-100 bg-white text-slate-700 font-medium"
                >
