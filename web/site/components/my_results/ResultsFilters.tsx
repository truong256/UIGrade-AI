...
export function ResultsFilters({
    ...
    return (
        <section className="rounded-2xl border border-sky-100 bg-white p-4 shadow-xs">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="h-10 w-full rounded-xl border border-slate-200 bg-white pl-9 pr-3 text-xs outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-100"
                        />
                    </div>
                </div>
