...
export function ResultDetailPanel({ item }: ResultDetailPanelProps) {
    return (
        <aside className="rounded-3xl border border-blue-100 bg-white p-5 shadow-sm xl:sticky xl:top-24">
            {!item ? (
                <div className="rounded-2xl border border-dashed border-blue-100 bg-blue-50/30 px-4 py-10 text-center text-xs text-slate-400">
                ...
                <div className="space-y-4">
                    ...
                    <div className="rounded-2xl border border-blue-100 bg-blue-50/50 p-4">
                        ...
                        <div className="mt-2 flex items-end gap-2">
                            <span className="text-4xl font-black text-blue-950">{formatScore(item.finalScore)}</span>
                    ...
                    <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2 xl:grid-cols-1">
                        ...
                        <FeedbackListCard
                            ...
                            className="border-blue-200 bg-blue-50/60 text-blue-950 [&>p]:text-blue-800"
                        />
                    </div>
