            ...
            <div>
                <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                        <span className="rounded-lg bg-blue-50 border border-blue-200/60 px-2.5 py-0.5 text-xs font-semibold text-blue-700">
                                ...
                                {openMenu ? (
                                    <div className="absolute right-0 top-9 z-20 w-40 overflow-hidden rounded-xl border border-slate-200 bg-white py-1 shadow-xl animate-in fade-in zoom-in-95 duration-100">
                                        <button
                                            ...
                                            className="flex w-full items-center gap-2 px-3.5 py-2 text-left text-xs font-medium text-slate-700 transition hover:bg-slate-50"
                                        >
                ...
                <p className="mt-3 line-clamp-2 text-xs text-[#4A5568] leading-relaxed">
