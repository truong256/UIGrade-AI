...
export function AssignmentsTopBar() {
    return (
        <header className="sticky top-0 z-50 border-b border-blue-100 bg-white/95 backdrop-blur-md px-6 py-3">
            <div className="mx-auto flex max-w-[1200px] items-center justify-between">
                <div className="flex items-center gap-8">
                    <Link href="/ui/dashboard" className="flex items-center gap-2.5">
                        ...
                        <h2 className="text-lg font-black tracking-tight text-slate-900">
                            UIGrade <span className="text-blue-600 font-extrabold">AI</span>
                        </h2>
                    </Link>
                ...
                <div className="flex items-center gap-3">
                    <button type="button" className="rounded-full p-2 text-slate-500 transition-colors hover:bg-blue-50 hover:text-blue-600">
                        <span className="material-symbols-outlined text-[20px]">notifications</span>
                    </button>

                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 to-blue-400 text-white text-xs font-bold shadow-xs">
                        GV
                    </div>
                </div>
            </div>
